...
"! reacts to a click, then the Z2UI5_CCC BSP is deployed, the abap2UI5 frontend
"! resolves the reserved resourceRoot <em>z2ui5_ccc</em>, and both the control
...
CLASS z2ui5_cl_ccc_sample_00 IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    " the control this repository ships - z2ui5_ccc/cc/Example.js
