...
sap.ui.define(
  [
    ...
    "z2ui5_ccc/Util",
    "z2ui5_ccc/fonts/MyCustomFontFamily",
  ],
  (Control, IconPool, Util, MyCustomFontFamily) => {
    "use strict";
    ...
    // "MyCustomFontFamily.woff2", which is the name UI5 insists on.
    //
    ...
    const ICON_FONTS = [MyCustomFontFamily];
